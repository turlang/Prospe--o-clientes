# Arquitetura — LeadHunter Pro 25.5.0
...
O script `verify-landing-build.js` exige a versão `25.5.0`, os cinco painéis, os controles de navegação e as regras de viewport. Assim, a aplicação não volta silenciosamente para a landing antiga.
