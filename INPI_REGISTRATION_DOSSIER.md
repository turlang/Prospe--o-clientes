# LeadHunter Pro — Dossiê de Preparação para Registro no INPI

**Data de preparação:** 24/08/2026  
**Repositório:** `turlang/Prospe--o-clientes`  
**Baseline técnica indicada para o pedido:** `bdc7f4f83eb0666e19a0930f328f596cc8b17307`  
**Branch preservada:** `ip-provenance-ready-2026-08-24`  
**Tag de evidência planejada:** `ip-provenance-2026-08-24`

## 1. Objeto do registro

LeadHunter Pro é um sistema operacional comercial para prospecção, auditoria digital, priorização de oportunidades, CRM 360, tarefas, follow-ups, conversas, propostas, inteligência comercial e automações. O objeto pretendido do registro é a expressão concreta do programa de computador contida na baseline acima.
...
- [ ] inexistência de dados de clientes, leads reais, segredos ou material confidencial dentro do pacote técnico.
...
- Backend: Node.js 20, Express 4, MongoDB Atlas/Mongoose, JWT, bcryptjs, Helmet, CORS e Fast CSV.
- Frontend: HTML/JavaScript/CSS modular, React, Vite e Tailwind na landing.
- Domínios: prospecção, auditoria digital, CRM, inteligência comercial, propostas, clientes, billing e omnichannel.
- Integrações: Google Places, Groq, Gemini, OpenAI, Resend, Mercado Pago e contratos preparados para canais de mensageria.
...
Este dossiê não reivindica titularidade sobre Express, MongoDB, Mongoose, React, Vite, APIs, provedores, marcas, bibliotecas ou outros materiais de terceiros. O pedido deve se limitar ao código e demais expressão protegível criada legitimamente para o LeadHunter Pro.
