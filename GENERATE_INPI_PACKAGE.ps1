param(
  [string]$TargetCommit = "bdc7f4f83eb0666e19a0930f328f596cc8b17307",
  [string]$OutputDir = ""
)

$ErrorActionPreference = "Stop"
$Repository = "turlang/Prospe--o-clientes"
$ProjectSlug = "leadhunter-pro"
...
if (-not $OutputDir) {
  $OutputDir = Join-Path $env:USERPROFILE "Documents\INPI-Evidence\LeadHunter-Pro"
}
