...
test('assets críticos usam cache-busting da versão 26.0.0', () => {
  assert.match(read('public/pages/app.html'), /app\.js\?v=26\.0\.0/);
  assert.match(read('public/pages/admin.html'), /admin\.js\?v=26\.0\.0/);
});
