...
```text
Prospe--o-clientes-ip-provenance-2026-08-24-<sha12>.zip
Prospe--o-clientes-ip-provenance-2026-08-24-<sha12>.zip.sha256
```
...
```powershell
Get-FileHash .\Prospe--o-clientes-ip-provenance-2026-08-24-<sha12>.zip -Algorithm SHA256
gh attestation verify .\Prospe--o-clientes-ip-provenance-2026-08-24-<sha12>.zip --repo turlang/Prospe--o-clientes
```
