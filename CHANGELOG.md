...
- Remove arquivos do DevBurger misturados ao repositório.
- Elimina módulos, páginas públicas e componentes React legados não utilizados.
- Reforça os gates arquiteturais e adiciona regressão de higiene do pacote.
- Atualiza metadados e cache-busting para 26.2.0 sem alterar dados ou regras de negócio.
